...
declare namespace Framework7 {
	...
	interface Framework7Options {
		...
		preroute?: (view: View, options: any) => void;
	...
	interface ViewParameters {
		...
		reloadPages?: boolean;
		preroute?: (view: View, options: any) => void;
		preprocess?: (content: any, url: string, next: any) => void;
	...
	interface AutocompleteOptions {
		openIn?: string;
		source?: (autocomplete: Autocomplete, query: string, render: any) => void;
		limit?: number;
		preloader?: boolean;
...
declare namespace Swiper {
	interface SwiperOptions {
		...
		onSetTransition?: (swiper: Swiper, transition: boolean) => void;
...
declare class Template7 {
	static registerHelper(name: string, handler: (arr: any, options: any) => any): void;
}
...
declare class Framework7 {
	...
	// Notifications
	addNotification(parameters: Framework7.NotificationOptions): void;
